...
class ForwardRateAgreementSpecification(interfaces.FactoryObject):
    ...
    def __init__(self,
        ...
        self.trade_date = trade_date #date contract is created
        self.spot_date = spot_date
        self.fixing_date = fixing_date #date at which index.rate determined, lag (e.g. 2 days) before start_date
        self.start_date = start_date #start accrual
        self.maturity_date = maturity_date #end accrual

        self.FRA_rate = FRA_rate # agreed upon FIXED rate for the accrual period
        self.index_rate = ref_rate # value of the reference index on the fixing date, The actual market rate that will be observed on the fixing date
