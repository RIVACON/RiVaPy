...
class NIG_CIR(FactoryObject):
    ...
    def __init__(self, alpha: Union[float, Callable], beta:Union[float, Callable],delta:Union[float, Callable],
        ...
        """NIG_CIR process as in https://perswww.kuleuven.be/~u0009713/ScSiTi03.pdf
        ...
        self.y0 = y0
        self._timegrid = None
        self.modelname = 'NIG_CIR'

    def _to_dict(self) -> dict:
        return {'alpha':self.alpha, 'beta':self.beta,'delta':self.delta, 'kappa':self.kappa, 'eta':self.eta,'lmbda':self.lmbda,'y0':self.y0}
