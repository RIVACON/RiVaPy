...
class BondSpecificationTests(TestCase):
    ...
    def test_bond_specification(self):
        ...
        zero_coupon_bond = ZeroBondSpecification(
            "US500769CH58", datetime(2007, 6, 29), datetime(2037, 6, 29), "USD", 1000, "KfW", SecuritizationLevel.SENIOR_UNSECURED
        )
        ...
        # fixed rate bond
        fixed_rate_bond = FixedRateBondSpecification.from_master_data(
            "DE000CZ40NT7",
            datetime(2019, 3, 11),
            datetime(2024, 9, 11),
            0.0125,
        ...
        # floating rate bond
        floating_rate_note = FloatingRateBondSpecification.from_master_data(
            "DE000HLB3DU1",
            datetime(2016, 6, 23),
            datetime(2024, 6, 27),
            "3M",
...
class BondPricingTests(TestCase):
    ...
    def test_yield_bond(self):
        ...
        bond_spec = PlainVanillaCouponBondSpecification(
            "PV_BOND",
        ...
        bond_price = DeterministicCashflowPricer.pv_cashflows(ref_date, bond_spec, dc)
        bond_yield = DeterministicCashflowPricer.compute_yield(target_dirty_price=bond_price, val_date=ref_date, specification=bond_spec)
